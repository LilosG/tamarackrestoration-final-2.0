---
title: "Fire Damage Restoration Process: What to Expect Step by Step"
...
relatedCities: ["carlsbad", "oceanside", "vista", "san-marcos"]
featured: false
draft: false
---
...
1. **Fire damage** — structural destruction and charring from direct flame contact
2. **Smoke and soot damage** — residue deposits on surfaces throughout the home, often far from the fire itself
3. **Water damage** — from firefighting efforts, which can be as destructive as the fire
...
1. **Document everything** before any cleanup begins
2. **Keep all receipts** for emergency expenses
3. **Don't dispose of damaged items** until the adjuster has seen them
4. **Get a professional scope of work** from a restoration company—not just the insurance company's estimate
5. **Understand your policy** — know the difference between replacement cost and actual cash value coverage
6. **Keep a claim journal** documenting all conversations with dates, names, and summaries
