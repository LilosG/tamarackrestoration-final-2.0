...
export const services: Service[] = [
  {
    ...
    icon: 'droplet',
    image: '/images/services/water-damage/living-room-dryout.jpg',
    features: [
  ...
  },
  {
    ...
    icon: 'search',
    image: '/images/services/leak-detection/thermal-camera-wall.jpg',
    features: [
  ...
  },
  {
    ...
    icon: 'shield',
    image: '/images/services/mold/moisture-meter.jpg',
    features: [
  ...
  },
  {
    ...
    icon: 'flame',
    image: '/images/services/fire/containment-setup.jpg',
    features: [
  ...
  },
  {
    ...
    icon: 'waves',
    image: '/images/services/flood/basement-flood.jpg',
    features: [
  ...
  },
  {
    ...
    icon: 'alert-triangle',
    image: '/images/services/sewage/bathroom-cleanup.jpg',
    features: [
...
export const leakServices: Service[] = [
  {
    ...
    icon: 'home',
    image: '/images/services/leak-detection/thermal-plumbing.jpg',
    features: [
  ...
  },
  {
    ...
    icon: 'radar',
    image: '/images/services/leak-detection/thermal-camera-garage.jpg',
    features: [
      'Thermal imaging',
...
export const insuranceCarriers: InsuranceCarrier[] = [
  {
    ...
    name: 'State Farm',
    slug: 'state-farm',
    logo: '/images/insurance/insurance-state-farm.png',
  ...
  },
  {
    ...
    name: 'Allstate',
    slug: 'allstate',
    logo: '/images/insurance/insurance-allstate.png',
  ...
  },
  {
    ...
    slug: 'farmers',
    logo: '/images/insurance/insurance-farmers.png',
  ...
  },
  {
    ...
    name: 'USAA',
    slug: 'usaa',
    logo: '/images/insurance/insurance-usaa.png',
  ...
  },
  {
    ...
    name: 'Liberty Mutual',
    slug: 'liberty-mutual',
    logo: '/images/insurance/insurance-liberty-mutual.png',
